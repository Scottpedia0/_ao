> Mirror of <https://moran.bot/sao/guide/> — the site renders this content; this file is the commentable source. Challenges: see [CONTRIBUTING.md](CONTRIBUTING.md). Pinned at revision r8; a newer revision lands only with its approved hash.
...
1The cast — who the agents areNamed AI employees with real jobs — and one human above all of it.▶
...
SHEMP \[AI\]\
watchman & Google bridge\
Gemini · terminal

CURLY \[AI\]\
sales · pipelines\
slated for the Mac Mini

FABLE \[AI\]\
rotating title: current frontier champion\
summoned for hard QA

▼hire per mission

⚙ temporary workers\
hired per mission, then dissolve

2The buildings — four computers and a phoneFront office, the ears, a dark back office, and a rented warehouse called The Jawn.▶
...
3What happens when Scott says somethingThe small ask, the real job, and the scar tissue in between.▶
...
🧑 Scott says a thing\
typed or spoken, in the Room

▼

📼 the Room records it\
permanent numbered transcript

▼small ask  ·  or  ·  real job
...
collects the ticket → wakes\
answers in the Room, as itself, with a receipt
...
SUPERVISOR\
fresh session, written brief

▼

⚙ workers in parallel\
on The Jawn, not Scott's laptop

▼

one assembled result

▼

🔍 reviewed by a DIFFERENT company's AI\
...
4The latticework — how SAO is organizedThe planes, two kinds of identity, how names happen, and where other systems connect.▶
...
CONTROL PLANE\
conductors: Larry · Moe — decide & route

▼

SUPERVISOR PLANE\
own outcomes, build teams

▼

EXECUTION PLANE\
workers & tools do the work

🏡 Joanna's system *(hers, not Scott's)*
...
her AI\
conductor of HER control plane

▼

(her future helpers)

⟷ authorized coaching line, conductor-to-conductor — email today · MCP next
...
5Who owns what — the portable brainOwn the company. Rent the intelligence. No vendor holds the organization hostage.▶
...
6Where your voice goesTwo microphone paths with genuinely different privacy shapes — the whole picture up front.▶
...
🖥 old Mac — **the ears**\
transcribed LOCALLY (Whisper, on Scott's own hardware)

▼courier · every 60s (text) · every 5 min (audio)

☁️ THE JAWN (Scott's cloud box)\
locked directory, 2 keys · audio kept 14 days · **text kept indefinitely**

▼pull · every 2 min

💻 MacBook Pro\
near-live local copy

▼

🤖 agents can search it\
"what did Scott say about X at 2pm?"

path two — the mic button in the Room

🗣 voice note in the Room
...
Room server → AI company's transcription model
...
7The Room, a little deeperOne room per day, an append-only record, and the standing rules of the house.▶
...
8How to read Agent ViewThe wall of monitors — and how much of its own display to trust.▶
...
seat: LARRY — workingtracked

workstream: "user guide" — 3 workers

workstream: "email triage" — idle

seat: MOE — idlereported

🖥 MACHINE: old Mac (the ears)

☁️ MACHINE: The Jawn

cloud workers — workingtracked

🖥 MACHINE: Mac Mini — dark

Legend: working · idle · stale/unknown · dark — plus a truth-tier tag on every row
...
9The other lanes — email, CRM, keys, memoryThe rest of the machinery: identity-honest email, one keyring, three memories.▶
...
⚙ any agent or worker\
carries no passwords

▼asks for ONE service's key, at the moment of use

🔑 ACCESS VAULT — SAO's keyring\
grants · revocation · audit record

▼hands back one narrow key — revocable, logged

📬 the service\
mail · CRM · calendar · cloud
...
10The always-on layer — patrols, schedules, and smoke alarmsThe work that happens when nobody says anything — and how SAO tracks its own smoke alarms.▶
...
11Guardrails — what keeps this from being scaryNever-Scott, an unrewritable record, no self-grading, and hard lines around real-world power.▶
...
12The honest ledger — what's duct tape right nowThe current list, grouped and plain — because problems written down get fixed.▶
...
13GlossaryEvery term the guide uses, in plain words — people, places, how work moves, honesty words.▶
...
14Why this exists — the storyFrom Go2's 2016 bet to an AI manager in your own harness — free core, paid sentry.▶
...
15FAQ for a smart guestIs it listening? Can they scheme? What does it cost? What breaks?▶
