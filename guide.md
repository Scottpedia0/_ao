<!-- Mirror of https://moran.bot/sao/guide/ — approved r11 source bytes sha256 109c3b95d129ce18ea2d33e69b4f9773500786094984d4cf63490b65bc42a435; document content verbatim below. Challenges: see CONTRIBUTING.md. -->
...
And the biggest name of all follows the same logic. The pattern is **AO — Agent Orchestration** — and each person names their instance after themselves. Scott's is SAO. Joanna's is JAO. Yours takes your initial. The name is the owner's, never ours: you own the identity, the record, and the contracts from the first word. What's shared is the pattern and the commons — the **conductor collective**, the community of participating conductors — never a brand.
...
| **AO** | the naming pattern: Agent Orchestration, prefixed with the owner's initial — SAO is Scott's, JAO is Joanna's, yours takes yours; the name belongs to the owner, the pattern to the commons |
| **conductor collective** | the community of participating conductors across people's AOs |
